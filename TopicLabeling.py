...
class TopicLabeling(object):
 ...
 def labeling_process(self, ontology, type):
     ...
     for a in articles:
         ...
         print('----------------')
         print("Article: " + a)
         file = "Data-Articles/"+type+"csv/" + a + ".csv"
         ...
         onto2 = TopicOntology.TopicOnto(ontology, file)
         print('test')
         ...
         for t in commontopic4:
             ...
             hyper = self.allhyper(entityid)
             if (hyper.__contains__(pentityid) == False and hyper.__contains__(
                     oentityid) == False and hyper.__contains__(prentityid) == False and hyper.__contains__(
                 lentityid) == False):
         ...
         for at in arrayoftopics:
             arrayoftopicslabel.append(self.getLabel(at))
